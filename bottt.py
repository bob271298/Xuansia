...
lv_upgrade_multitap = 10
lv_upgrade_energy = 10
...
Hinata sexy Bruntal
    ...
    print(Fore.GREEN + Style.BRIGHT + "Update Link: https://github.com/bob271298")
    print(Fore.YELLOW + Style.BRIGHT + "Free Konsultasi Join Telegram Channel: https://t.me/Tipangmas1")
    print(Fore.BLUE + Style.BRIGHT + "Buy Vvip ?")
    print(Fore.RED + Style.BRIGHT + "NOT USE HARD :)")
    print(Fore.GREEN + Style.BRIGHT + "\n=============================================")
    print(Fore.YELLOW + Style.BRIGHT + "\n\rRecode By Hinata ( https://t.me/Tipang27 )")
    print(Fore.GREEN + Style.BRIGHT + "\n=============================================")
#print kombo
